...
class WaterVolumeReadingEntityTest implements RandomLocalDateTimeGenerator {
  ...
  void testRequiredParameters() {
    assertThrows(NullPointerException.class, () -> new WaterVolumeReadingEntity(null, localDateTime1, consumedWater1));
