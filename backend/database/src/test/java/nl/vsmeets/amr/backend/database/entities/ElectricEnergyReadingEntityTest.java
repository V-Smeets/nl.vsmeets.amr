...
class ElectricEnergyReadingEntityTest implements RandomShortGenerator, RandomLocalDateTimeGenerator {
  ...
  void testRequiredParameters() {
    ...
    assertThrows(NullPointerException.class,
        () -> new ElectricEnergyReadingEntity(meter1, null, tariffIndicator1, consumedEnergy1, producedEnergy1));
    assertThrows(NullPointerException.class,
