...
public class ElectricPowerFailureEventFactoryBean implements ElectricPowerFailureEventFactory {
   ...
   */
  private final ElectricPowerFailureEventRepository repository;
   ...
   */
  @Autowired
  public ElectricPowerFailureEventFactoryBean(final ElectricPowerFailureEventRepository repository) {
    super();
