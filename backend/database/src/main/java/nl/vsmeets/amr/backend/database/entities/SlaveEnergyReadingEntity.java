...
@Entity
@Table(name = "slave_energy_reading")
public class SlaveEnergyReadingEntity extends AbstractTableEntity implements SlaveEnergyReading {
    ...
    /**
     * 0-n:24.2.1.255 The consumed energy in watt hour (Wh).
     */
    @NonNull
    @Getter
    @ToString.Include
