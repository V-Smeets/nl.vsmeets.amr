...
public class MeterFactoryBean implements MeterFactory {
   ...
   */
  @Autowired
  public MeterFactoryBean(final MeterRepository repository) {
    super();
  ...
  public Meter create(final P1Telegram p1Telegram, final MeasuredMedium measuredMedium,
    ...
    final MeterEntity meter =
        new MeterEntity((P1TelegramEntity) p1Telegram, (MeasuredMediumEntity) measuredMedium, equipmentIdentifier);
    try {
