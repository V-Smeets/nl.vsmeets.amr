...
/**
 * A repository to access the {@link ThermalEnergyReadingEntity}.
 *
 * @author vincent
 */
public interface ThermalEnergyReadingRepository
        extends JpaRepository<ThermalEnergyReadingEntity, Integer>, RefreshRepository<ThermalEnergyReadingEntity> {

    /**
     * Find a {@link ThermalEnergyReadingEntity}.
     *
