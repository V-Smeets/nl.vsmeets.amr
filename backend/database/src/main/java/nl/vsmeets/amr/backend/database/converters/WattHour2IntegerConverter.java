...
/**
 * Convert between {@link Energy} watt hour (Wh) and {@link Integer}.
 *
 * @author vincent
 */
@Converter
public class WattHour2IntegerConverter implements AttributeConverter<Quantity<Energy>, Integer> {
  ...
  /**
   * The unit for {@link Energy} watt hour (Wh).
   */
   ...
   */
  public WattHour2IntegerConverter() {
    super();
  }
  ...
  public Integer convertToDatabaseColumn(final Quantity<Energy> energy) {
    autoWire();
    return energy.to(wattHour).getValue().intValue();
  }
