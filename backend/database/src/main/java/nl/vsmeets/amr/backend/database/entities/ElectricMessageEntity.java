...
@Entity
@Table(name = "electric_message")
public class ElectricMessageEntity extends AbstractTableEntity implements ElectricMessage {

    /**
     * The meter of this message.
     */
    @NonNull
    @Getter
    ...
    /**
     * 0-0:96.13.0.255 The text message
     */
    @NonNull
    @Getter
    @ToString.Include
