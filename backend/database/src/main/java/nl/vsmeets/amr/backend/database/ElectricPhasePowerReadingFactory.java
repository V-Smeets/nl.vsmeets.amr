...
public interface ElectricPhasePowerReadingFactory {
   ...
   * @param instantaneousCurrent
   *        The instantaneous current.
   * @param instantaneousConsumedPower
   *        The instantaneous consumed power.
   * @param instantaneousProducedPower
   *        The instantaneous produced power.
