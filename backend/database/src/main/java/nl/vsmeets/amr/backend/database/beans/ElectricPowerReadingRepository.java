...
/**
 * A repository to access the {@link ElectricPowerReadingEntity}.
 *
 * @author vincent
 */
public interface ElectricPowerReadingRepository
        extends JpaRepository<ElectricPowerReadingEntity, Integer>, RefreshRepository<ElectricPowerReadingEntity> {

    /**
     * Find a {@link ElectricPowerReadingEntity}.
     *
