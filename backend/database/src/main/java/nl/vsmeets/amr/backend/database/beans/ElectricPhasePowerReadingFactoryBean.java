...
public class ElectricPhasePowerReadingFactoryBean implements ElectricPhasePowerReadingFactory {
   ...
   */
  private final ElectricPhasePowerReadingRepository repository;
   ...
   */
  @Autowired
  public ElectricPhasePowerReadingFactoryBean(final ElectricPhasePowerReadingRepository repository) {
    super();
