...
@Entity
@Table(name = "gas_volume_reading")
public class GasVolumeReadingEntity extends AbstractTableEntity implements GasVolumeReading {
    ...
    /**
     * 0-n:24.2.1.255 The consumed gas in cubic deci meter (dm3).
     */
    @NonNull
    @Getter
    @ToString.Include
    @Column(name = "consumed_gas", nullable = false)
    @Convert(converter = CubicDeciMeter2IntegerConverter.class)
    private Quantity<Volume> consumedGas;
