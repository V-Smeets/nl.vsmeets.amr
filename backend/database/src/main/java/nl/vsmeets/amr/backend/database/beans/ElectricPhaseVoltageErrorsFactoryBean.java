...
public class ElectricPhaseVoltageErrorsFactoryBean implements ElectricPhaseVoltageErrorsFactory {
   ...
   */
  private final ElectricPhaseVoltageErrorsRepository repository;
   ...
   */
  @Autowired
  public ElectricPhaseVoltageErrorsFactoryBean(final ElectricPhaseVoltageErrorsRepository repository) {
    super();
