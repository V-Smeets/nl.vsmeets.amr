...
public class P1TelegramFactoryBean implements P1TelegramFactory {
   ...
   */
  private final P1TelegramRepository repository;
   ...
   */
  @Autowired
  public P1TelegramFactoryBean(final P1TelegramRepository repository) {
    super();
  ...
  public P1Telegram create(final Site site, final String headerInformation, final Byte versionInformation)
    ...
    final P1TelegramEntity p1Telegram = new P1TelegramEntity((SiteEntity) site, headerInformation, versionInformation);
    try {
